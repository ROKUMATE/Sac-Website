        ...
        <footer className="bg-[#0B2F5C] text-white">
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p className="text-sm">
                            ...
                            Technology and Management, Gwalior is an autonomous
                            institute set up by the Government of India, MHRD.
                        </p>
                        <div className="mt-4 flex items-center">
                            <MapPin size={16} className="mr-2" />
                            <address className="text-sm not-italic">
                                Morena Link Road, Gwalior, Madhya Pradesh, India
                                - 474015
                            </address>
                        </div>
                    </div>
                ...
                <div className="mt-8 pt-6 border-t border-blue-800 text-center text-sm">
                    <p>
                        &copy; {new Date().getFullYear()} Student Activity
                        Council, ABV-IIITM Gwalior. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
