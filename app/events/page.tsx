...
const events = [
    {
        id: 1,
        title: "Infotsav - Techno Cultural Fest",
        date: "2025-10-01",
        time: "Coming Soon",
        venue: "IIITM Campus",
        description:
...
export default function EventsPage() {
    ...
    return (
        <div className="py-16 px-4 max-w-7xl mx-auto">
            <h1 className="text-3xl md:text-4xl font-bold text-[#0B2F5C] mb-8 text-center">
                Upcoming Events
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {sortedEvents.map((event) => (
                    <div
                        ...
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-[#0B2F5C] mb-4">
                                {event.title}
                            </h3>
