            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="max-w-2xl mx-auto text-gray-600">
                        The Faculty Coordinators provide guidance and support to
                        the Student Activity Council each academic year.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    <Link href="/faculty/2024" className="group">
                        <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 p-8 text-center h-full flex flex-col justify-between">
                            ...
                            <p className="text-gray-600 mb-6">
                                Meet our current faculty coordinators guiding
                                the Student Activity Council for the academic
                                year 2024-25.
                            </p>
                    ...
                    <Link href="/faculty/2023" className="group">
                        <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 p-8 text-center h-full flex flex-col justify-between">
                            <h2 className="text-2xl font-bold text-[#0B2F5C] mb-4">
                                Faculty 2023-24
                            </h2>
                            <p className="text-gray-600 mb-6">
                                Meet the faculty coordinators who guided the
                                Student Activity Council during the academic
                                year 2023-24.
                            </p>
                            <div className="flex justify-center items-center text-[#0B2F5C] group-hover:text-blue-700 transition-colors">
                                <span className="font-medium">
